...
func get_scoring_values(hand_type: int, scoring_context: HandScoringContext = null) -> Dictionary:
	...
	if scoring_context != null:
		var upgrade: Dictionary = scoring_context.get_hand_type_upgrade(hand_type)
